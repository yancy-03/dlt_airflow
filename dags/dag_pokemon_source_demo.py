...
def load_pokemon_source_demo_data():
    ...
    from pokemon import pokemon_source as source

    # modify the pipeline parameters 
    pipeline = dlt.pipeline(pipeline_name='pokemon_source_demo',
